...
export const ProductImages = ({ images, productName }: ProductImagesProps) => {
  ...
  return (
    <div className="space-y-4 max-w-2xl w-full flex gap-2.5">
      ...
      <div className="relative flex-1">
        ...
        {/* Magnified view */}
        {showZoom && (
          <div className="absolute left-full top-0 ml-2 w-80 h-80 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden pointer-events-none z-10">
            <div
