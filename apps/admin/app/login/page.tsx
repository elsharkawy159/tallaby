...
export default function AuthPage() {
  ...
  // Sign In Form
  const signInForm = useForm<AdminSignInFormData>({
  ...
  // Reset Password Form
  const resetForm = useForm<AdminResetPasswordFormData>({
  ...
  const handleSignIn = (data: AdminSignInFormData) => {
  ...
  const handleResetPassword = (data: AdminResetPasswordFormData) => {
    startTransition(async () => {
      try {
    ...
    <div className="min-h-screen flex items-center justify-center from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-4">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Access your admin account to manage products and orders
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...signInForm}>
