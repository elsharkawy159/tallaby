...
function ChangeLabel({ value }: { value: number }) {
  ...
  return (
    <div
      className={`flex items-center pt-1 text-xs ${isPositive ? "text-green-600" : "text-red-600"}`}
    >
    ...
    <>
      <div className="mb-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(commerce.revenue.current)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(commerce.aov.current)}
            </div>
        ...
        <TabsContent value="customers" className="mt-6 space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Average revenue per unique buyer each month
              </CardDescription>
            </CardHeader>
            <CardContent className="h-[300px]">
        ...
        <TabsContent value="categories" className="mt-6 space-y-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Revenue, catalog size, and period growth
                </CardDescription>
              </CardHeader>
              <CardContent>
                <table className="w-full">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Period-over-period growth by category
              </CardDescription>
            </CardHeader>
            <CardContent className="h-[400px]">
              <BarChart
