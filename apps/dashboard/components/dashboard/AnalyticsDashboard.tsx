"use client";
import { DollarSign, ShoppingBag, Package, Star, TrendingUp, Users } from 'lucide-react';
...
export const AnalyticsDashboard = () => {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{t('dashboard.title')}</h1>
        <p className="text-gray-600 dark:text-gray-400">{t('dashboard.performanceInsights')}</p>
      </div>
