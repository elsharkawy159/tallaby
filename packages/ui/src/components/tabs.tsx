...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted text-muted-foreground border border-input inline-flex md:h-10 h-9 w-fit items-center justify-center rounded-lg p-0.5",
        className
      )}
      {...props}
    />
