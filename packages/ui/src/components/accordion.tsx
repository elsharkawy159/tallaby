  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "focus-visible:border-ring bg-gray-100 px-4 font-semibold focus-visible:ring-ring/50 flex flex-1 items-start justify-between gap-4 rounded-lg py-3.5! cursor-pointer text-start text-sm transition-all outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 [&[data-state=open]>svg]:rotate-180",
          className
        )}
        {...props}
      >
