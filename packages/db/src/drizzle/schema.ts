...
export const attributes = pgTable(
  ...
  (table) => [
    uniqueIndex("attribute_slug_idx").using(
      "btree",
...
export const categoryAttributes = pgTable(
  ...
  (table) => [
    uniqueIndex("category_attribute_idx").using(
      "btree",
...
export const categories = pgTable(
  ...
  (table) => [
    ...
    index("category_parent_id_idx").using(
      "btree",
      table.parentId.asc().nullsLast().op("uuid_ops")
    ),
    uniqueIndex("category_slug_idx").using(
      "btree",
      table.slug.asc().nullsLast().op("text_ops")
    ),
    foreignKey({
...
export const categoryPath = pgTable(
  ...
  (table) => [
    uniqueIndex("category_path_idx").using(
      "btree",
      table.categoryId.asc().nullsLast().op("uuid_ops"),
      table.pathId.asc().nullsLast().op("uuid_ops")
    ),
    foreignKey({
      columns: [table.categoryId],
      foreignColumns: [categories.id],
...
export const deals = pgTable(
  ...
  (table) => [
    index("deal_seller_id_idx").using(
      "btree",
      table.sellerId.asc().nullsLast().op("uuid_ops")
    ),
    index("deal_type_idx").using(
      "btree",
      table.dealType.asc().nullsLast().op("enum_ops")
    ),
    foreignKey({
      columns: [table.sellerId],
      foreignColumns: [sellers.id],
...
export const productAttributes = pgTable(
  ...
  (table) => [
    index("prod_attr_attribute_id_idx").using(
      "btree",
      table.attributeId.asc().nullsLast().op("uuid_ops")
    ),
    index("prod_attr_product_id_idx").using(
      "btree",
      table.productId.asc().nullsLast().op("uuid_ops")
    ),
    uniqueIndex("product_attribute_idx").using(
      "btree",
      table.productId.asc().nullsLast().op("uuid_ops"),
      table.attributeId.asc().nullsLast().op("uuid_ops")
    ),
...
export const attributeValues = pgTable(
  ...
  (table) => [
    index("attr_val_attr_id_idx").using(
      "btree",
      table.attributeId.asc().nullsLast().op("uuid_ops")
    ),
    uniqueIndex("attr_val_unique_idx").using(
      "btree",
      table.attributeId.asc().nullsLast().op("text_ops"),
...
export const productVariants = pgTable(
  ...
  (table) => [
    index("variant_product_id_idx").using(
      "btree",
      table.productId.asc().nullsLast().op("uuid_ops")
    ),
    uniqueIndex("variant_sku_idx").using(
      "btree",
      table.sku.asc().nullsLast().op("text_ops")
    ),
    foreignKey({
...
export const productCategories = pgTable(
  ...
  (table) => [
    index("prod_cat_category_id_idx").using(
      "btree",
      table.categoryId.asc().nullsLast().op("uuid_ops")
    ),
    index("prod_cat_product_id_idx").using(
      "btree",
      table.productId.asc().nullsLast().op("uuid_ops")
    ),
    foreignKey({
