import { pgTable, index, foreignKey, uuid, text, integer, jsonb, timestamp, numeric, varchar, smallint, unique, boolean, uniqueIndex, real, pgPolicy, bigint, date, pgEnum } from "drizzle-orm/pg-core"
...
export const products = pgTable("products", {
	...
	pgPolicy("Allow anyone to insert products", { as: "permissive", for: "insert", to: ["anon", "authenticated"] }),
]);
