...
import { carts, cartItems, productListings, products, sellers, productVariants, attributes, categoryAttributes, categories, categoryPath, coupons, users, deliveries, shipments, deals, notifications, orderItems, orders, userAddresses, productQuestions, productAnswers, productAttributes, attributeValues, paymentMethods, payments, productImages, refunds, returns, productViews, returnItems, brands, reviews, reviewVotes, searchLogs, sellerDocuments, sellerPayouts, shipmentItems, sellerPayoutItems, couponUsage, reviewComments, userDevices, wishlists, wishlistItems, productCategories } from "./schema";
...
export const productListingsRelations = relations(productListings, ({one, many}) => ({
	...
	seller: one(sellers, {
		fields: [productListings.sellerId],
		references: [sellers.id]
	}),
	productVariant: one(productVariants, {
		fields: [productListings.variantId],
		references: [productVariants.id]
	}),
}));
...
export const productsRelations = relations(products, ({one, many}) => ({
	...
	productListings: many(productListings),
